...
export class AutoScalingResources extends Construct {
    ...
    constructor(scope: Construct, id: string, props: AutoScalingResourceProps) {
        ...
        this.autoScalingGroup = new autoscaling.AutoScalingGroup(
            ...
            `${props.name}-asg`,
            {
                autoScalingGroupName: `${props.name}-asg`,
        ...
        if (props.lambdaResources != undefined) {
            ...
            this.autoScalingGroup.addLifecycleHook(`${props.name}-scale-up-lifecycle-hook`, {
            ...
            this.autoScalingGroup.addLifecycleHook(`${props.name}-scale-down-lifecycle-hook`, {
                heartbeatTimeout: Duration.seconds(300),
                defaultResult: autoscaling.DefaultResult.ABANDON,
            ...
            const lambdaName = `${props.name}-asg-lifecycle-lambda`.slice(0, 64);
            ...
            const rule = new events.Rule(this, `${props.name}-event-rule`, {
                eventPattern: {
            ...
            NagSuppressions.addResourceSuppressions(
                ...
                [
                    ...
                    },
                    {
                        ...
                        reason:
                            'Auto Scaling Lifecycle Lambda Function uses manged policy AWSLambdaVPCAccessExecutionRole',
                    },
                ],
                true
            );
