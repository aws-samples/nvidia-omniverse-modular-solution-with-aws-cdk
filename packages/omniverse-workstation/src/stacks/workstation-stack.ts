...
import { SecurityGroupCollection, SubnetCollection } from 'omniverse-vpc';
import { JumpboxResources } from '../constructs/jumpbox';
import { WorkstationResources } from '../constructs/workstation';
